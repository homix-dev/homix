"use strict";(()=>{var e={};e.id=680,e.ids=[680],e.modules={145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6249:(e,o)=>{Object.defineProperty(o,"l",{enumerable:!0,get:function(){return function e(o,n){return n in o?o[n]:"then"in o&&"function"==typeof o.then?o.then(o=>e(o,n)):"function"==typeof o&&"default"===n?o:void 0}}})},1861:(e,o,n)=>{n.r(o),n.d(o,{config:()=>l,default:()=>d,routeModule:()=>O});var i={};n.r(i),n.d(i,{default:()=>r});var t=n(1802),c=n(7153),a=n(6249);let s=`#!/bin/bash
#
...
`;function r(e,o){o.setHeader("Content-Type","text/plain; charset=utf-8"),o.setHeader("Cache-Control","no-cache, no-store, must-revalidate"),o.status(200).send(s)}let d=(0,a.l)(i,"default"),l=(0,a.l)(i,"config"),O=new t.PagesAPIRouteModule({definition:{kind:c.x.PAGES_API,page:"/api/installer",pathname:"/api/installer",bundlePath:"",filename:""},userland:i})},7153:(e,o)=>{var n;Object.defineProperty(o,"x",{enumerable:!0,get:function(){return n}}),function(e){e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE"}(n||(n={}))},1802:(e,o,n)=>{e.exports=n(145)}};var o=require("../../webpack-api-runtime.js");o.C(e);var n=o(o.s=1861);module.exports=n})();